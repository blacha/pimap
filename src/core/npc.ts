...
function isTownFolk(code: NpcCode) {
  switch (code) {
    // Act 1
    case NpcCode.Charsi:
    case NpcCode.Gheed:
...
function isMonster(code: NpcCode) {
...
function isResurrecter(code: NpcCode) {
  switch (code) {
...
function isDoll(code: NpcCode) {
  switch (code) {
    ...
    case NpcCode.UndeadStygianDoll:
    case NpcCode.UndeadStygianDoll2:
      return true;
    default:
      return false;
  }
...
function isSoul(code: NpcCode) {
  switch (code) {
    ...
    case NpcCode.BlackSoul2:
    case NpcCode.BurningSoul:
    case NpcCode.BurningSoul2:
    case NpcCode.BurningSoul3:
    case NpcCode.Gloam:
    case NpcCode.Gloam2:
      return true;
    default:
